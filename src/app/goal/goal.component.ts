...
export class GoalComponent implements OnInit {
  ...
  goals: Goal[] = [
    new Goal(1, 'Watch finding Nemo', 'Find an online version and watch merlin find his son',new Date(2020,11,14)),
    new Goal(2,'Buy Cookies','I have to buy cookies for the parrot',new Date(2020,12,9)),
    new Goal(3,'Get new Phone Case','Diana has her birthday coming up soon',new Date(2022,10,12)),
    new Goal(4,'Get Dog Food','Pupper likes expensive snacks',new Date(2020,9,18)),
